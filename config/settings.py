...
SECRET_KEY = 'django-insecure-+)4t58e0af)nsx!^hvx&hf69vu-hqv535silx-5pzhw7a*(akd'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Furniture Backend API',
    'DESCRIPTION': 'API documentation for Furniture Backend',
    'VERSION': '1.0.0',
